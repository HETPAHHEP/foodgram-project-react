...
class Command(BaseCommand):
    """Команда Django для импорта ингредиентов из CSV в соответствующую таблицу"""
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(
            f'{Ingredient.__name__} data from {csv_file} imported successfully. Total rows: {total_rows}'))
